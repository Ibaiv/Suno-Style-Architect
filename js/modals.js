...
function getModalsHTML() {
    ...
    <div id="visual-engine-modal" class="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center p-4 z-50 hidden modal-enter-from">
        <div class="modal-content bg-neutral-800/50 border border-neutral-700 rounded-3xl shadow-2xl p-6 w-full max-w-lg">
            ...
            <div id="ve-progress-area" class="ve-progress-container mt-4">
                <div class="ve-spinner">
                    <div class="ve-spinner-ring"></div>
                    <div class="ve-spinner-ring"></div>
                    <div class="ve-spinner-ring"></div>
                </div>
                <div class="ve-progress-bar-track">
                    <div id="ve-progress-bar" class="ve-progress-bar-fill"></div>
                </div>
                <div id="ve-progress-status" class="ve-progress-status">Bild wird generiert...</div>
                <div id="ve-progress-elapsed" class="ve-progress-elapsed"></div>
                <button id="ve-cancel-btn" class="ve-cancel-btn" type="button">Abbrechen</button>
            </div>
